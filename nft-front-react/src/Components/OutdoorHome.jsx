...
const OutdoorHome = () => {
    ...
    return (
        <div className="flex">
            <aside className="h-screen md:w-72 w-0 bg-red-400">
            ...
            <div className=" text-2xl flex-1 h-screen bg-white">
                <div className='w-full h-32 bg-black fixed'>
                    <div className='flex p-7 place-content-center	'>
                        <h1 className='text-bold text-6xl text-green-200'>Weedmaniac</h1>
                    </div>
                </div>
                <div className='p-16 bg-red-200 h-screen overflow-scroll	'>
                    <p className='p-7 pt-16'>The standard Lorem Ipsum passage, used since the 1500s
